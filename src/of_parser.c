...
ofp_msg_log(const void *b, struct pcap_pkthdr hdr) {
  ...
  struct ofp_multipart_request *reqp = NULL;
  struct ofp_multipart_reply *repp = NULL;
  int count = 0;
